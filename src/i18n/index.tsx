...
const D: Dict = {
  ...
  ti_who_body: {
    ru: "Год рождения с 2003 по текущий год включительно. Команда от 3 до 7 человек + до 10 помощников.",
    kk: "2003 жылдан бастап ағымдағы жылға дейін туғандар. 3–7 адамдық топ + 10-ға дейін көмекші.",
    en: "Born from 2003 through the current year inclusive. Team of 3 to 7 + up to 10 helpers.",
  },
  ...
  sub_film_title: {
    ru: "Название на оригинале и английском",
    kk: "Түпнұсқа және ағылшын тіліндегі атауы",
    en: "Title in original language and English",
  },
  sub_theme: { ru: "Тема фильма", kk: "Фильм тақырыбы", en: "Film theme" },
  sub_theme_1: { ru: "Конец или начало", kk: "Конец или начало", en: "Конец или начало" },
  sub_theme_2: { ru: "Мои заботы", kk: "Мои заботы", en: "Мои заботы" },
  sub_desc: { ru: "Краткое описание", kk: "Қысқаша сипаттама", en: "Short description" },
  sub_genres: {
    ru: "Жанры (до 3, через запятую)",
    kk: "Жанрлар (3-ке дейін, үтірмен)",
    en: "Genres (up to 3, comma-separated)",
  },
  ...
  sub_reach: {
    ru: "Reach — от 50 до 150 слов",
    kk: "Reach — 50-ден 150 сөзге дейін",
    en: "Reach — 50 to 150 words",
  },
  sub_connect: {
    ru: "Connect — от 50 до 150 слов",
    kk: "Connect — 50-ден 150 сөзге дейін",
    en: "Connect — 50 to 150 words",
  },
  sub_doc: {
    ru: "Портфолио (PDF, до 3 страниц А4, до 10 МБ)",
    kk: "Портфолио (PDF, 3 A4 бетке дейін, 10 МБ-қа дейін)",
    en: "Portfolio (PDF, up to 3 A4 pages, up to 10 MB)",
  },
  ...
  sub_p_phone: { ru: "Номер телефона", kk: "Телефон нөмірі", en: "Phone number" },
