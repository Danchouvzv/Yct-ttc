    ...
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <header className="reveal text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl font-serif italic text-muted-foreground">
          Международный турнир короткометражного кино. Соберите команду,
          снимите фильм по одной из двух тем и поборитесь за призовой фонд.
        </p>
      ...
      <div className="mt-16 space-y-12">
        <Section icon={Users} title="Формат участия">
          <Bullet>Команда от <b>3 до 7 человек</b>, включая капитана.</Bullet>
          <Bullet>Команда представляет съёмочную группу фильма. Актёры могут входить в её состав.</Bullet>
          <Bullet>Дополнительно можно указать <b>до 10 помощников</b> (массовка, организаторы).</Bullet>
          <Bullet>Состав команды можно менять <b>до момента отправки фильма</b>.</Bullet>
          <Bullet>Фильм снимается на <b>одну из двух предложенных тем</b>.</Bullet>
          <Bullet>Максимальный возраст участников — <b>2003 год рождения и младше</b>. Минимального ограничения нет.</Bullet>
          <Bullet>Продолжительность фильма: <b>5–16 минут</b>.</Bullet>
          <Bullet>Языки фильма: <b>казахский, русский или английский</b>.</Bullet>
          <Bullet>Регистрация открыта вплоть до дедлайна.</Bullet>
          <Bullet>Каждая команда обязана создать <b>Instagram-аккаунт</b> для участия в Connect & Reach.</Bullet>
          <Bullet>Доп. баллы — за сложные кинематографические приёмы (one shot, mix media, match cut, POV, time manipulation, свет как инструмент).</Bullet>
        </Section>
        ...
        <Section icon={Instagram} title="Connect & Reach">
          ...
          <div className="mt-3 space-y-2">
            ...
            <Bullet>Все публикации используют <b>официальный хэштег турнира</b>.</Bullet>
        ...
        <Section icon={ShieldCheck} title="Отбор фильмов">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Card>
              ...
              <p className="mt-2 font-serif italic text-foreground/85">
                Лучшие фильмы передаются профессиональным режиссёрам, экспертам киноиндустрии и профильным специалистам для финального оценивания.
              </p>
            </Card>
          </div>
        </Section>
        ...
        <Section icon={FileText} title="Требования к заявке">
          <Bullet>Название команды <b>на английском языке</b>.</Bullet>
          <Bullet>
            Фильм: снят на одну из двух тем; продолжительность <b>5–16 минут</b>; язык — казахский, русский или английский; без сторонних брендов и скрытой рекламы (допускаются спонсоры турнира).
          </Bullet>
          <Bullet>Название фильма на <b>оригинальном языке и на английском</b>.</Bullet>
          <Bullet>Краткое описание фильма <b>до 75 слов</b>.</Bullet>
          <Bullet>До <b>3 жанров</b>.</Bullet>
          <Bullet>Перечень выполненных условий для доп. баллов с указанием <b>временных отметок</b>.</Bullet>
          <Bullet>Описание деятельности команды в рамках Connect & Reach — <b>50–150 слов на каждую награду</b>.</Bullet>
          <Bullet>Портфолио до <b>3 страниц A4</b>.</Bullet>
          <Bullet>
            Полный список участников с ролями: режиссёр, оператор, монтажёр, актёр, другие роли. Дополнительно <b>до 10 помощников</b>. Все имена и фамилии — <b>латиницей</b>.
          </Bullet>
        </Section>
        ...
        <Section icon={Languages} title="Языки и темы">
          ...
          <Bullet>Язык фильма: казахский, русский или английский. Заявка заполняется на английском.</Bullet>
        </Section>
        ...
        <Section icon={ListChecks} title="Что проверить перед отправкой">
          ...
          <Bullet>Заполнены тайминги для доп. баллов и блоки Connect & Reach.</Bullet>
